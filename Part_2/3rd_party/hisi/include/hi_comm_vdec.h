...
typedef struct hi_VDEC_DECODE_ERROR_S {
    ...
    HI_S32 s32StreamSizeOver; /* R; the stream size is too big and force discard stream */
...
typedef struct hiVDEC_PARAM_VIDEO_S {
    HI_S32 s32ErrThreshold; /* RW, Range: [0, 100]; */
...
typedef enum hiVDEC_CAPACITY_STRATEGY_E {
...
typedef struct hiVDEC_PICTURE_MOD_PARAM_S {
    HI_U32 u32MaxPicWidth;
    HI_U32 u32MaxPicHeight;
    HI_BOOL bSupportProgressive;
    HI_BOOL bDynamicAllocate;
